use dioxus::prelude::*;
use select::{
    SelectGroupLabelProps, SelectGroupProps, SelectListProps, SelectOptionProps, SelectProps,
...
#[component]
pub fn SearchingSelect<T: Clone + PartialEq + 'static>(props: SelectProps<T>) -> Element {
    rsx! {
        ...
        select::Select {
            ...
            typeahead_buffer: props.typeahead_buffer,
            {props.children}
        }
    }
}
